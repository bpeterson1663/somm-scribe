...
import type { COLOR_INDEX } from "@/components/color-palette/color-palette.constant";
...
describe("<ColorPalette />", () => {
  ...
  it("should render correct color", () => {
    ...
    cy.get(`[data-testid="${backgroundColor}"]`).should(
      "have.attr",
      "style",
      "background: radial-gradient(at center bottom, rgb(250, 249, 229) 58%, rgb(255, 255, 255) 71%);",
    );
  });
});
